...
import { Calendar, Heart, Stars, ArrowRight, Sparkles, User, Clock, Target, Award, Star } from 'lucide-react'; // Added Star here
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <button 
                ...
                className="px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-lg font-semibold rounded-full hover:from-purple-700 hover:to-blue-700 transform hover:scale-105 transition-all duration-200 shadow-lg"
              >
                Generate Free Kundali
              </button>
              <button 
                onClick={() => router.push('/astrology/horoscope')}
                className="px-8 py-4 border-2 border-purple-600 text-purple-600 text-lg font-semibold rounded-full hover:bg-purple-600 hover:text-white transition-all duration-200"
              >
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Simple steps to unlock your cosmic insights</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Provide your birth date, time, and place for accurate calculations</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Our advanced algorithms analyze planetary positions and cosmic influences</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Receive detailed insights, predictions, and personalized guidance</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Trusted by thousands of satisfied users</p>
          </div>
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={() => router.push('/astrology/kundali-making')}
              className="px-8 py-4 bg-white text-purple-600 text-lg font-semibold rounded-full hover:bg-gray-100 transition-colors"
            >
              Start Your Free Kundali
            </button>
            <button 
              onClick={() => router.push('/astrology/kundali-matching')}
              className="px-8 py-4 border-2 border-white text-white text-lg font-semibold rounded-full hover:bg-white hover:text-purple-600 transition-colors"
            >
              Check Compatibility
            </button>
          </div>
