...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const res = await fetch("https://astro-nine-beige.vercel.app/api/user/profile", {
          method: "GET",
  ...
  async function handleSave() {
    ...
    try {
      ...
      const refreshRes = await fetch("https://astro-nine-beige.vercel.app/api/user/profile", {
        method: "GET",
        headers: getAuthHeaders(),
      });
  ...
  async function handleDelete() {
    setDeleting(true);
    try {
      const res = await fetch("https://astro-nine-beige.vercel.app/api/user/delete", {
        method: "DELETE",
        headers: getAuthHeaders(),
      });
