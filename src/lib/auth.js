...
export const authOptions = {
  ...
  providers: [
    ...
    Credentials({
      ...
      async authorize(credentials) {
        ...
        const res = await fetch("https://astro-nine-beige.vercel.app/api/api/auth/verify-session", {
          method: "POST",
  ...
  const res = await fetch("https://astro-nine-beige.vercel.app/api/api/auth/google-signin", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({
      email: user.email,
